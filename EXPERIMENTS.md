...
- [__KL0_mix_100rms_mean_disjoint_10-mixens_1061682](https://wandb.ai/distill-llms/policy-evaluation/runs/znmynyme) {0.6B-Base-SFT} — mean
- [min_KL0_mix_100rms_min_disjoint_10-mixens_1061683](https://wandb.ai/distill-llms/policy-evaluation/runs/7rznh8wf) {0.6B-Base-SFT} — min
- [high-uwo_KL0_mix_100rms_uwo10_random_disjoint_10-mixens_1061681](https://wandb.ai/distill-llms/policy-evaluation/runs/w9rq5zie) {0.6B-Base-SFT} — UWO `λ=10`, `random_disjoint` partition

### Q: Mix-of-ensembles vs full-ensemble vs sequential-cycling at 100 RMs?
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=0366ddhlp9x)
- [40ens_KL0.005_ensemble_41rms_mean_1061686](https://wandb.ai/distill-llms/policy-evaluation/runs/klzsajm6) {0.6B-Base-SFT} — full ensemble of 41 RMs, mean
- [__KL0_mix_100rms_mean_disjoint_10-mixens_1061682](https://wandb.ai/distill-llms/policy-evaluation/runs/znmynyme) {0.6B-Base-SFT} — 100 RMs, mix-10×10 disjoint, mean
...
- [full-ds_KL0.005_100rms_sequential3x_1062944](https://wandb.ai/distill-llms/policy-evaluation/runs/tdbu4tnq) {0.6B-Base-SFT} — 3×
- [1x_KL0.005_100rms_sequential1x_1062161](https://wandb.ai/distill-llms/policy-evaluation/runs/vc2f073s) {0.6B-Base-SFT} — 1×
...
- [100_sequential_3x_0.005KL_1036533](https://wandb.ai/distill-llms/policy-evaluation/runs/jjp2nkwe) {0.6B-Base-SFT} — β=0.005
...
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=d6euyg8w17h)
- [sequential_10best_3x_0.01KL_1022174](https://wandb.ai/distill-llms/policy-evaluation/runs/45ch0pv2) {0.6B-Base-SFT} — top-10 best, sequential3x — picks from **100-series bank @ ckpt-218**
- [sequential_10_3x_0.01KL_reorder_1022017](https://wandb.ai/distill-llms/policy-evaluation/runs/xcg07mww) {0.6B-Base-SFT} — all-10, sequential3x — ⚠️ uses an entirely different RM family (**994415–995148 series @ ckpt-284**), not a superset of the "top-10 best"
...
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=071cyuzaxqh)
...
- [1e-5lr_KL0_1rms_sequential3x_1099071](https://wandb.ai/distill-llms/policy-evaluation/runs/872sf4xt) {3.5-4B-SFT} (used as the lr=1e-5 baseline in the GR3 group)
...
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=tpyqzwnfw2n)
- [Qwen3-8B_KL0_1rms_sequential3x_1069470](https://wandb.ai/distill-llms/policy-evaluation/runs/9okigr2v) {0.6B-Base-SFT} — full-FT — ⚠️ **the underlying GRPO run is a 0.6B model** despite the run name; this is *not* an actual 8B comparison
- [8B-LoRA-policy-4BInstructRM_KL0_1rms_sequential3x_1074475](https://wandb.ai/distill-llms/policy-evaluation/runs/v9qa5abk) {8B-Base} — LoRA, default lr
- [8B-LoRA-higherLR_KL0_1rms_sequential3x_1074580](https://wandb.ai/distill-llms/policy-evaluation/runs/5irdcj8d) {8B-Base} — LoRA, higher lr
...
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=carae2klspn)
- [qwen3.5_FP32mamba_KL0_1rms_sequential3x_1086797](https://wandb.ai/distill-llms/policy-evaluation/runs/82vdkzkw) {3.5-4B-SFT} — first run that completes after `0f20ad2` *qwen3.5_FP32mamba*
- [Qwen3.5-4B-Base-sft](https://wandb.ai/distill-llms/policy-evaluation/runs/1ppfr693) {3.5-4B-SFT} — earlier attempts that crashed without the patch (commits `281821a` *vllm + transformers patch 48*, `22d13436` *patch eval*)

### Q: Annotation source for the 4B SFT — helpsteer3 alone vs with human responses?
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=h0e58k7hd7z)
Commit `cd74de5` *-human option for dataset annotation* added the `--human` mode.
- [3.5-4B-both_KL0_1rms_sequential3x_1078525](https://wandb.ai/distill-llms/policy-evaluation/runs/592ug9hu) {3.5-4B-SFT} — Qwen3.5-4B with both helpsteer3 + human
- [3.5B-base-both-human_KL0_1rms_sequential3x_1084314](https://wandb.ai/distill-llms/policy-evaluation/runs/ywy5hz5o) {3.5-4B-SFT} — Qwen3.5-3.5B with both
...
- [qwen3.5-4b_KL0_1rms_sequential3x_1069471](https://wandb.ai/distill-llms/policy-evaluation/runs/s1fiv1uc) {0.6B-Base-SFT} — Qwen3.5-4B without SFT
...
- [dpo_sigmoid_4B-Base_1089353](https://wandb.ai/distill-llms/policy-evaluation/runs/6cyhd9z3) {3.5-4B-SFT} — default β
...
### Other / standalone
[Comparison](https://wandb.ai/distill-llms/policy-evaluation?nw=viedpzdyzb5)
