...
CHECKPOINTS_DIR="/nas/ucb/eop/Reward-Model-Overoptimization/scripts/rlhf/logs_grpo/20250821_121959" # Current directory with all checkpoints
...
python evaluate_policy.py \
    ...
    --subsample_n 25 \
    --continue_from_checkpoint "checkpoint-4532" \
    --wandb_continue_run_id "8mllca4h" \
    ${DEBUG_MODE:-} \
